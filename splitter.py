...
def split_line():
    ...
    print(Fore.RED+"\t["+Style.RESET_ALL+"#"+Fore.RED+"]"+Style.RESET_ALL+" Splitter Lines "+Fore.RED+"(Ex: 34000)"+Style.RESET_ALL)
    print(Fore.RED+"\t["+Style.RESET_ALL+"?"+Fore.RED+"]"+Style.RESET_ALL+" Enter Number Starting To Split (ex: 55):")
    num = int(input("\t>> "))
    print("Processing: "+Fore.GREEN+"{} - {} list".format(int(all_line(nama)), num)+Style.RESET_ALL)
    print("Result: "+Fore.GREEN+"{} Copyed".format(int(all_line(nama)) - num)+Style.RESET_ALL)
...
def split_text():
    ...
    nama_file = open(nama, "r")
    print(Fore.RED+"\t["+Style.RESET_ALL+"#"+Fore.RED+"]"+Style.RESET_ALL+" List Splitter Text "+Fore.RED+"(; : , | #)"+Style.RESET_ALL)
    print(Fore.RED+"\t["+Style.RESET_ALL+"?"+Fore.RED+"]"+Style.RESET_ALL+" Ex: [admin;pa213ss;sada@gmail.com]") 
    print(Fore.RED+"\t["+Style.RESET_ALL+"?"+Fore.RED+"]"+Style.RESET_ALL+"     [  0  ;   1   ;       2      ]  Number to split (ex: 2)? ")
    num = int(input("\t>> "))
    read_file = nama_file.readlines()
    with open("hasil-text.txt", "w") as nama_file:
        for line in tqdm(read_file):
            action = line.split(";"or","or":"or"|"or"#")
            input_action = action
...
try:
    print(Fore.RED+"["+Style.RESET_ALL+"?"+Fore.RED+"]"+Style.RESET_ALL+" Number Methode: ")
